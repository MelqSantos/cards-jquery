$(document).ready(function() {
    ...
    var texto =[
        ...
        {
            titulo: "Texto 02",
            comentario: "Programação com Jquery 02 <br> Simulando requisição GET..."
        },
        {
            titulo: "Texto 03",
            comentario: "Programação com Jquery 03 <br> Simulando requisição GET..."
        },
        {
            titulo: "Texto 04",
            comentario: "Programação com Jquery 04 <br> Simulando requisição GET..."
        }
    ];
